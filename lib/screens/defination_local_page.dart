...
class DefinationLocalPage extends StatefulWidget {
  final String definationLocalText;

  DefinationLocalPage({this.definationLocalText});

  @override
  _DefinationLocalPageState createState() => _DefinationLocalPageState();
}

class _DefinationLocalPageState extends State<DefinationLocalPage> {
